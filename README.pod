...
might take a while to read in the file, and cost a bit of memory).
...
following three are best installed from the CPAN shell:
...
goodies for this yet. Feel free to contribute these :-)
